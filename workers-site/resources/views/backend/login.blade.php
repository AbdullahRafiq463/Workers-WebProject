...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{url('frontend\assets\images\logo.jpg')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('frontend\assets\images\logo.jpg')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('frontend\assets\images\logo.jpg')}}">
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <img src="{{url('frontend\assets\images\logo.jpg')}}" height="70px" alt="{{config('app.name')}}"><br><br>
