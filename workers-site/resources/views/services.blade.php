                        ...
                        <div class="services-grids services-grid-view">
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-1.jpg" alt class="bg-image">
                            ...
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-2.jpg" alt class="bg-image">
                                            <a href="service-single.html">
                            ...
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-3.jpg" alt class="bg-image">
                                            <a href="service-single.html">
                            ...
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-4.jpg" alt class="bg-image">
                                            <a href="service-single.html">
                            ...
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-5.jpg" alt class="bg-image">
                                            <a href="service-single.html">
                            ...
                            <div class="grid">
                               <div class="inner mk-bg-img">
                                    <div class="details ">
                                       <div class="info">
                                            <img src="frontend/assets/images/services/img-6.jpg" alt class="bg-image">
                                            <a href="service-single.html">
